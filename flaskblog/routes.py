...
from flaskblog.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm,ResetPasswordForm,TransferForm
...
def send_reset_email(user):
    ...
    If you did not make this request then simply ignore this email and no changes will be makde '''
    mail.send(msg)
